...
namespace Training.DomainClasses
{
    public class PetShop
    {
        ...
        {
            return _petsInTheStore.ThatSatisfy(Pet.IsSpeciesEqual(Species.Mouse));
        }

        public IEnumerable<Pet> AllFemalePets()
        {
            return _petsInTheStore.ThatSatisfy(Pet.IsSexEqual(Sex.Female));
        }
        ...
        {
            return _petsInTheStore.ThatSatisfy(Pet.IsSpeciesNotEqual(Species.Mouse));
        }
